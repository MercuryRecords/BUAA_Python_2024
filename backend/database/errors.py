...
E_PROBLEM_GROUP_REPEAT = JsonResponse({"code": 402, "message": "题单已存在"})
E_PROBLEM_GROUP_NOT_FIND = JsonResponse({"code": 402, "message": "题单不存在"})
...
E_ILLEGAL_ANSWER = JsonResponse({"code": 407, "message": "答案不合法"})
...
E_NO_PROBLEM_GROUP = JsonResponse({"code": 409, "message": "题单列表为空"})
E_NO_PROBLEM = JsonResponse({"code": 409, "message": "题目列表为空"})
E_PAGE_OVERFLOW = JsonResponse({"code": 410, "message": "页码越界"})
E_GROUP_NOT_FIND = JsonResponse({"code": 411, "message": "用户群组不存在"})
E_USER_NOT_IN_GROUP = JsonResponse({"code": 411, "message": "用户不在此用户群组中"})
...
E_WORD_ILLEGAL = JsonResponse({"code": 421, "message": "请传入合法的正则表达式"})
