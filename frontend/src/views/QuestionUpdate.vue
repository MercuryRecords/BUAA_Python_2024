...
import UpdateQuestion from "@/components/Base/UpdateQuestion.vue";
</script>
      ...
      <el-container class="main-container">
        ...
        <el-container>
          <el-main class="shifted-content">
            <!--              主体内容-->
            <UpdateQuestion :username="$route.query.username" :sheetId="$route.query.sheetId"
                            :problem_id="$route.query.problem_id"></UpdateQuestion>
          </el-main>
        </el-container>
      </el-container>
